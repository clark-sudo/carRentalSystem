...
//          float rentalPrice = 1f;
            if (selectedRow != -1) {
                try {
                    ...
                    String carModel = txtModel.getText();
                    String availability = cmbAvailable.getSelectedItem().toString();
                    float rentalPrice = Float.parseFloat(txtPrice.getText());
  
                    rentalCars car = carsList.get(selectedRow);
                    car.setCarRegNo(carId);
                    car.setCarMake(brandMake);
                    ...
                    dfltModel.setValueAt(
                            carId, selectedRow, 0 );
                    dfltModel.setValueAt(
                            brandMake, selectedRow, 1 );
                    dfltModel.setValueAt(
                            carModel, selectedRow, 2 );
                    dfltModel.setValueAt (
                            rentalPrice, selectedRow, 3 );
                    dfltModel.setValueAt(
            ...
            if (carId.isEmpty() || brandMake.isEmpty() || carModel.isEmpty() || txtPrice.getText().isEmpty()) {
            ...
            try {
                ...
                rentalCars car = new rentalCars(carId, brandMake, carModel, rentalPrice, availability);
                carsList.add(car);
