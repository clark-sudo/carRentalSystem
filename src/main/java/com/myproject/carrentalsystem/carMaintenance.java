 ...
 * @author hicru
 */
public class carMaintenance extends JFrame implements ActionListener{
    ...
    carMaintenance() {
        ...
        txtCarParts.setBounds(250, 190, 200, 40);
        add(txtCarParts);
        
        txtQuantity = new JTextField();
        txtQuantity.setBounds(250, 250, 200, 40);
        add(txtQuantity);
        
        txtUnitPrice = new JTextField();
        txtUnitPrice.setBounds(250, 310, 200, 40);
        add(txtUnitPrice);
